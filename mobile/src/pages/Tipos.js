...
import { SafeAreaView, View, Button, Image, StyleSheet } from "react-native";
...
export default function Tipos({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.fundo}>
      ...
      <View style={styles.container}>
        <Button title="Lâmpadas" onPress={() => handleSubmit("lampadas")} />
      </View>
      <View style={styles.container}>
        <Button
      ...
      <View style={styles.container}>
        <Button title="Pneus" onPress={() => handleSubmit("pneus")} />
      </View>
      <View style={styles.container}>
        <Button title="Óleos" onPress={() => handleSubmit("oleos")} />
      </View>
    </SafeAreaView>
  );
}
